...
-- [Cơ bản]  Không cho phép xóa sản phẩm theo điều kiện
...
-- [Cơ bản] Tự động cập nhật ngày cập nhật cuối
...
-- [Khá] 4. Tự Động Cập Nhật Tổng Số Lượng Trong Kho
...
-- [Giỏi] Ghi Lịch Sử Thay Đổi Số Lượng Với Phân Loại
...
-- [Xuất sắc]  Đồng Bộ Dữ Liệu Giữa Các Bảng
